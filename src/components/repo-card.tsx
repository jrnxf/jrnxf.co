    ...
    >
      <div className="flex items-start justify-between gap-2">
        ...
        <HugeiconsIcon
          ...
          size={14}
          className="mt-0.5 flex-shrink-0 text-neutral-600 transition-[translate,color] duration-200 ease-out group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-white group-focus-visible:-translate-y-0.5 group-focus-visible:translate-x-0.5 group-focus-visible:text-white"
        />
      </div>
