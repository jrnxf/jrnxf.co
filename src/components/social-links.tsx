...
const socialLinks: { url: string; label: string; icon: ComponentType<IconProps> }[] = [
  { url: "https://github.com/jrnxf", label: "github", icon: GithubIcon },
  { url: "https://linkedin.com/in/jrnxf", label: "linkedin", icon: LinkedinIcon },
  { url: "https://instagram.com/jrn.xf", label: "instagram", icon: InstagramIcon },
  { url: "https://twitter.com/jrn_xf", label: "twitter", icon: TwitterIcon },
  { url: "https://www.youtube.com/@jrnxf", label: "youtube", icon: YoutubeIcon },
];
